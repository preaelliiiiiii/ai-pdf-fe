...
export default function DocumentList({
  ...
  const handleView = (doc: any) => {
    if (doc.url) {
      ...
      alert("URL not available for this document");
    }
  };
              ...
              >
                ...
                <td className="p-4 text-right">
                  <div className="flex justify-end gap-2">
                    <button
                      onClick={() => handleView(doc)}
                      className="text-blue-600 hover:text-blue-800 p-2 hover:bg-blue-50 
                    ...
                    <button
                      ...
                      className="text-red-600 hover:text-red-800 p-2 hover:bg-red-50 
